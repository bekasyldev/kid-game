...
export default function Home() {
  ...
  return (
    <div>
      <section className="h-[100vh] overflow-hidden overflow-y-auto w-[100vw] bg-no-repeat bg-cover"  style={{ backgroundImage: "url('/assets/main-bg.jpg')" }}>
        <section className="max-w-[1200px] mx-auto h-full">
          <section className="h-full flex flex-col justify-center gap-32">
            ...
            <ul className="flex gap-4">
              {links.map((link) => (
                <li key={link.title} className="bg-[--primary] flex-1 flex items-center justify-center text-center cursor-pointer p-8 rounded-2xl bg-primary">
